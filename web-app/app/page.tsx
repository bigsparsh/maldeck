...
const Page = () => {
  ...
  return (
    <div className="relative mx-auto flex h-screen w-full flex-col items-center justify-center overflow-hidden rounded-3xl">
      <Header className="self-top absolute top-0 left-0 w-full z-90" />
      <h2 className="relative z-20 mx-auto max-w-4xl text-center text-2xl font-bold text-balance text-white md:text-4xl lg:text-6xl">
        Get the
        <span className="relative z-20 inline-block rounded-xl bg-blue-500/40 px-4 py-1 text-white underline decoration-sky-500 decoration-[6px] underline-offset-[16px] backdrop-blur-sm">
          security
        </span>{" "}
        your buisness deserves.
      </h2>
      <p className="relative z-20 mx-auto max-w-2xl py-8 text-center text-sm text-neutral-200 md:text-base">
        You have the best buisness ever, now secure it with us so it keeps on growing and provide a smoother and stress free user experience. And let us handle the hard stuff.
      </p>
